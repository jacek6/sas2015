...
def vectorize(docs, ngramRange=(1,2)):
    """
...
def classifySentiment(X, y, n_folds=10, classifier=None):
    """
...
if __name__ == "__main__":
    ...
    for cls in classifiers:
        ...
        results = classifySentiment( X=X, y=y, n_folds=4, classifier=eval(cls)() )
